...
11. If that external review requests changes, the Leader delegates accepted fixes to a subagent, then reruns Tester, Type Interface Organizer when applicable, Final Reviewer, and the external review gate.
